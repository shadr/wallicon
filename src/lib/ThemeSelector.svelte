		...
		{#each visibleThemes as theme}
			...
			>
				...
				{#if selectedTheme.id === theme.id}
					<div class="absolute top-1 right-1 h-4 w-4 rounded-full bg-violet-500 flex items-center justify-center" aria-hidden="true">
						<svg class="h-2.5 w-2.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
